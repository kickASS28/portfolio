...
const ExpressjsLogo = ({ night }) => {
  ...
  return (
    <a
      ...
      rel="noreferrer"
    >
      <li className={classes.techlogo} key="react">
        <svg viewBox="0 0 32 32" width="54" height="48">
          <path
            fill={night ? "#FFF" : "#000"}
        ...
        <p className={`${!showTooltip ? classes.hide : ""}`}>ExpressJS</p>
      </li>
    </a>
  );
};
