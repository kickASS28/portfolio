...
const NextjsLogo = ({ night }) => {
  ...
  return (
    <a
      ...
      rel="noreferrer"
    >
      <li className={classes.techlogo} key="next">
        <svg height="46" fill={night ? "#FFF" : "#000"} viewBox="0 0 48 48">
        ...
        <p className={`${!showTooltip ? classes.hide : ""}`}>NextJS</p>
      </li>
    </a>
  );
};
