...
const MongoDBLogo = ({ night }) => {
  ...
  return (
    <a
      ...
      rel="noreferrer"
    >
      <li className={classes.techlogo} key="mongodb">
        <svg xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 0 32 32">
          <path
        ...
        <p className={`${!showTooltip ? classes.hide : ""}`}>MongoDB</p>
      </li>
    </a>
  );
};
